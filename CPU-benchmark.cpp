...
{
    double s = (double)(tv1.tv_sec - tv2.tv_sec);   // Calculate time difference in seconds
    double us = (tv1.tv_usec - tv2.tv_usec)/1000000.0; // Calculate time difference in Micro-seconds
